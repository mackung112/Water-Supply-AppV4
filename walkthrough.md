...
### 4.1 ปุ่มออกรายงานแบบแยก (3 ปุ่ม)

- **การแก้ไข**: ก่อนหน้านี้มีการรวมปุ่มออกรายงานเป็นปุ่มเดียว แต่พบปัญหาเบราว์เซอร์ของบางเครื่องบล็อก Pop-up จึงได้ทำการ**แยกกลับมาเป็น 3 ปุ่ม** (ใบแจ้งราคา, ประมาณการ, ผังติดตั้ง) เหมือนเดิม
- **ผลลัพธ์**: ผู้ใช้สามารถคลิกเปิดรายงานทีละหน้าต่างได้ตามปกติ ป้องกันปัญหาเบราว์เซอร์ไม่อนุญาตให้เปิดหลายแท็บพร้อมกัน
...
### 4.5 ระบบรักษาความปลอดภัย (Login Popup)

- **การแก้ไข**: เพิ่มหน้าต่าง Popup บังหน้าจอแอปทั้งหมดเมื่อเข้าใช้งานครั้งแรก (ต่อ Session)
- **ผลลัพธ์**: ผู้ใช้ต้องกรอกรหัสผ่าน `1160@OES` ให้ถูกต้องก่อนจึงจะเข้าถึงฟังก์ชันต่างๆ ในแอปพลิเคชันได้ หากรหัสผ่านผิดจะมีการแจ้งเตือน "รหัสผ่านไม่ถูกต้อง" ระบบออกแบบมาให้สวยงาม พรีเมียม (Glassmorphism + Gradient) และสามารถเข้าสู่ระบบโดยกดปุ่ม Enter จากคีย์บอร์ดได้ทันที

### 4.6 เปลี่ยนรูปโลโก้ท้ายใบรายงาน (R1)

- **การแก้ไข**: เปลี่ยนรูปภาพส่วนท้าย (Footer) ของรายงาน "ใบแจ้งราคา" (R1)
- **ผลลัพธ์**: จากรูปเดิมถูกเปลี่ยนไปใช้ไฟล์ใหม่ `assets/images/โลโก้ท้ายหนังสือ.png` ตามที่ระบุ

### 4.7 ปรับปรุงการจัดวางหน้าใบแจ้งราคา (R1)

- **การแก้ไข**: ปรับปรุงขนาดและตำแหน่งในไฟล์ `r1.css`
- **ผลลัพธ์**: 
  - โลโก้ตราครุฑด้านบนสุด ถูกปรับขนาดให้ใหญ่ขึ้นเป็น **2 เซนติเมตร**
  - บรรทัด "วันที่" ถูกปรับให้เยื้องขวา โดยเริ่มต้นพิมพ์จาก**กึ่งกลางหน้ากระดาษ**พอดี (Margin Left 50%) ตามรูปแบบจดหมายราชการ
